...
class ValidationPasseport extends StatefulWidget {
  ...
  @override
  State<ValidationPasseport> createState() => _ValidationPasseportState();
}

class _ValidationPasseportState extends State<ValidationPasseport> {
  ...
  Future<bool> fetchData() async {
    http.Response response= await http.get(Uri.http(_baseUrl, "/passeport/getAllPasseportJSON"));
                    ...
                    return InkWell(
                      ...
                      onTap: ()=> showDialog<String>(
                        ...
                        builder: (BuildContext context) => AlertDialog(
                          title: const Text('Validation du passeport'),
                          content: Container(
                          ...
                          actions: <Widget>[
                            TextButton(
                              onPressed: () async {
                                http.Response response= await http.get(Uri.http(_baseUrl, "/passeport/deletePasseportJSON/"+_documents[index].user["id"].toString()));
                                print(response.body);
                            ...
                            TextButton(
                              onPressed: () async {
                                http.Response response= await http.get(Uri.http(_baseUrl, "/passeport/editPasseportJSON/"+_documents[index].user["id"].toString()));
                                print(response.body);
                                if(response.statusCode != 200)
                                {
                                  showDialog(
