      ...
      child: Stack(children: <Widget>[
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(191, 235, 180, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(79, 77)),
                ))),
        Positioned(
            top: 531,
            left: 244,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.all(Radius.elliptical(50, 51)),
                ))),
        Positioned(
            top: 381,
            left: 0,
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(235, 249, 234, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(163, 163)),
                ))),
        Positioned(
            top: 365,
            left: 346,
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(191, 235, 180, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(66, 65)),
                ))),
        Positioned(
            top: 262,
            left: 410,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(213, 234, 211, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(72, 73)),
                ))),
        Positioned(
            top: 237,
            left: 271,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(173, 202, 168, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(31, 31)),
                ))),
        Positioned(
            top: 171,
            left: 379,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(213, 234, 211, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(65, 66)),
                ))),
        Positioned(
            top: 100,
            left: 303,
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(154, 228, 153, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(40, 41)),
                ))),
        Positioned(
            top: 91,
            left: 189,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(173, 202, 168, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(78, 79)),
                ))),
        Positioned(
            top: 9,
            left: 93,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromRGBO(213, 234, 211, 1),
                  borderRadius: BorderRadius.all(Radius.elliptical(145, 147)),
                ))),
        Positioned(
          top: 602,
          left: 56,
